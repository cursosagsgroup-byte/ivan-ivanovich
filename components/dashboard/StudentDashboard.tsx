...
import { SEMINARIO_ONLINE_COURSE_ID, SEMINARIO_WHATSAPP_GROUP_URL } from '@/lib/course-constants';
                        ...
                        {activeTab === 'courses' && (
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                {enrolledCourses.map((course) => {
                                    const isSeminario = course.id === SEMINARIO_ONLINE_COURSE_ID;
                                    return (
                                    <div key={course.id} className="bg-slate-50 rounded-xl overflow-hidden hover:shadow-md transition-shadow group border border-slate-200">
                                        <div className="relative h-48 w-full overflow-hidden">
                                            ...
                                            {isSeminario ? (
                                                <div className="absolute top-3 right-3 bg-[#5C0A10] text-white px-2.5 py-1 rounded text-xs font-bold uppercase tracking-wide flex items-center gap-1.5">
                                        ...
                                        <div className="p-5">
                                            ...
                                            {isSeminario ? (
                                                <div>
                                                    <p className="font-semibold text-slate-900 mb-1">Únete al grupo de WhatsApp</p>
                                                    <p className="text-sm text-slate-500 mb-4">
                                                        Ahí recibirás los avisos del seminario en vivo, materiales y soporte directo.
                                                    </p>
                                                    <a
                                                        href={SEMINARIO_WHATSAPP_GROUP_URL}
                                                        target="_blank"
                                                        rel="noopener noreferrer"
                                                        className="w-full flex items-center justify-center gap-2 py-2.5 rounded-lg bg-[#25D366] text-white hover:bg-[#1da851] transition-colors text-sm font-semibold"
                                                    >
