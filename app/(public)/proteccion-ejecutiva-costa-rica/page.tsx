...
import { CheckCircle2, Shield, Award, MapPin, AlertTriangle } from 'lucide-react';
import CostaRicaLandingCTA from '@/components/landing/CostaRicaLandingCTA';
...
export default function CostaRicaLandingPage() {
    return (
                ...
                <div className="relative z-10 w-full max-w-7xl px-4 sm:px-6 lg:px-8 text-center text-white pt-10 md:pt-20">
                    <div className="animate-fade-in-up">
                        ...
                        <p className="text-lg md:text-3xl font-medium max-w-4xl mx-auto mb-8 md:mb-10 text-gray-200 px-2 leading-tight md:leading-normal">
                            Vive la experiencia táctica que te convertirá en un <span className="text-white font-bold">verdadero operador de élite</span> en Costa Rica.
                        </p>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                        ...
                        <div className="order-1 lg:order-2">
                            ...
                            <div className="space-y-4 md:space-y-6 text-base md:text-lg text-gray-700 leading-relaxed">
                                <p>
                                    Ha llegado el momento de que los profesionales de la protección ejecutiva en Costa Rica descubran el poder transformador de <span className="font-bold text-black">anticipar, planificar y ejecutar con criterio real en la calle</span>.
                                </p>
                                <p>
                ...
                <div className="max-w-5xl mx-auto px-4 text-center relative z-10">
                    ...
                    <div className="max-w-3xl mx-auto mb-8 md:mb-12">
                        <p className="text-lg md:text-2xl font-medium text-white mb-6">
                            Entrena con Iván Ivanovich, domina el método que ya ha transformado a cientos de profesionales en el continente, y lleva tu carrera a un nivel que pocos alcanzan en Costa Rica.
                        </p>
